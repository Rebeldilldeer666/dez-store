...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top" aria-labelledby="title"><div className="hero-copy"><p className="eyebrow">INDEPENDENT GOODS / EST. 2026</p><h1 id="title">Useful things for people making their own way.</h1><p className="intro">Digital tools and considered goods for independent builders, makers, and creative minds.</p><a className="hero-link" href="#catalog">Explore the collection <span aria-hidden="true">↓</span></a></div><div className="hero-note" aria-label="Store promise"><span>01</span><p>Made with intent.<br />Delivered securely.</p></div></section>
